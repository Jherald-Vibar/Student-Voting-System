...
<div class="max-w-7xl mx-auto p-4 sm:p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
        ...
        <a href="{{ route('election-winner') }}" class="bg-gradient-to-br from-purple-500 to-purple-700 text-white p-4 sm:p-6 rounded-2xl shadow-lg text-center hover:scale-105 transition-transform">
